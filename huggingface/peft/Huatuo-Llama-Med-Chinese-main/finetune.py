...
def train(
    ...
    data_path: str = os.path.join(dir_path, "data/llama_data.json"),
    output_dir: str = os.path.join(dir_path, "lora-llama-med-finetune"),
    ...
    model = LlamaForCausalLM.from_pretrained(
        base_model,
        load_in_8bit=False if device != "cuda" else True,
    ...
    trainer = transformers.Trainer(
        ...
        args=transformers.TrainingArguments(
            ...
            fp16=False, # Support CUDA devices only
